...
export const template = `<template>
    <v-card style="width: 500px;" class="pa-2">
        ...
        <v-card-subtitle>
            <ul>
                <li>
                    After selecting your node, click
                    <v-icon>
                        mdi-node-point
                    </v-icon>
                    on the left to show node properties.  From
        ...
        <v-card-text class="pa-2">
            ...
            Connectors for this node
            <v-spacer class="pa-2"></v-spacer>
            <v-icon class="ma-2">
                mdi-vuejs
            </v-icon>
            This node's appearnce (change this message)
            <v-spacer class="pa-2"></v-spacer>
            <v-icon class="ma-2">
                mdi-lambda
            </v-icon>
            Set what happens when this node is invoked
            <v-spacer class="pa-2"></v-spacer>
            <v-icon class="ma-2">
                mdi-graph-outline
            </v-icon>
            ...
            Local and public library of nodes you can import here
            <v-spacer class="pa-2"></v-spacer>
            <v-icon class="ma-2">
                mdi-cogs
            </v-icon>
            ...
            <v-alert
                ...
                elevation="2"
                class="ma-2">
Nodes are the buliding blocks of the graph.
<v-spacer class="ma-4"></v-spacer>
Nodes can do anything your host can do.
