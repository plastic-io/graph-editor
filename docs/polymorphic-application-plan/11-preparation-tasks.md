...
| 2 | **Decide the open questions that gate M1/M2:** Q-1 agent self-commit, Q-2 tenant model, Q-8 public editor default, D-8 retention; confirm or reject D-11 (templates lose Pinia stores/`transact`). | Q-1, Q-2, Q-8 decided 2026-09-20 (see §10.3); D-8 defaults accepted; **D-11 under discussion** | §10.2, §10.3 |
