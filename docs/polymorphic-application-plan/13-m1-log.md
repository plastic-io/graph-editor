...
| 2026-09-21 | Browser test of PB-014 against the AWS dev stage (real token, subprotocol echo) | **pending** (owner) | needs the editor preferences pointed at the AWS HTTPS/WSS URLs |
